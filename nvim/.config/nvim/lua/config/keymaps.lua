...
vim.api.nvim_set_keymap('n', '<C-\\>', "<cmd>lua require('nvim-tree.api').node.open.vertical()<cr>", { desc = "Vertical Split nvim tree file" })

-- Telescope
vim.api.nvim_set_keymap('n', 'ff', "<cmd>lua require('telescope.builtin').find_files()<cr>", { desc = "Search for files" })
